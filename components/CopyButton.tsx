...
export default function CopyButton({ text }: { text: string }) {
  ...
  return (
    <button
      onClick={handleCopy}
      className="inline-flex items-center justify-center p-1 rounded hover:bg-black/10 dark:hover:bg-white/10 transition-colors text-black/50 dark:text-white/50 hover:text-black dark:hover:text-white ml-1 relative group/copy"
