...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full backdrop-blur-sm bg-white/70 dark:bg-black/70 border-b border-black/10 dark:border-white/10 transition-colors duration-300">
